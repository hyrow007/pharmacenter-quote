...
const es: Record<string, string> = {
  ...
  "Setup Days": "Días de preparación",
  "Cleaning Days": "Días de limpieza",
  Setup: "Preparación",
  ...
  "Line Leaders Man Hours": "Horas hombre de líderes de línea",
  "Line Operators Man Hours": "Horas hombre de operadores de línea",
  "QTY of Line Leaders": "Cant. de líderes de línea",
  "QTY of Line Operators": "Cant. de operadores de línea",
  "Pay Rates": "Tarifas de pago",
  "Overhead Costs": "Costos generales",
  ...
  Test: "Prueba",
  "Cost per Test ($)": "Costo por prueba ($)",
  "Tests / Batch": "Pruebas / lote",
  "Lab Testing Cost / gummy": "Costo de laboratorio / gomita",
  ...
  "Batch Days": "Días de lote",
  "Batch Overhead": "Gastos generales del lote",
  "Batch Labor Costs": "Costos de mano de obra por lote",
  "Line Leader ($/hr)": "Líder de línea ($/h)",
  "Line Operator ($/hr)": "Operador de línea ($/h)",
  "Line Leaders": "Líderes de línea",
  "Line Operators": "Operadores de línea",
  "Hourly Base Rate": "Tarifa base por hora",
  "Payroll Tax %": "% impuestos de nómina",
  "Workers' Comp %": "% compensación laboral",
  "Burdened Rate": "Tarifa con cargas",
  Water: "Agua",
