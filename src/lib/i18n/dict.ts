...
const en = {
  ...
  soChatShared: "Shared with the team: everyone sees this thread.",
  soChatPlaceholder: "Ask anything about this order, or tell me what to correct…",
  soChatSend: "Send",
  soChatClose: "Close",
  soChatAttach: "Attach image or PDF",
  soChatMic: "Dictate",
  soChatListening: "Listening… tap to stop",
  soChatEmpty:
    "Ask about status, ETAs, quantities, POs, or who said what. Tell it a correction and it updates the card.",
  soChatSuggest1: "What's blocking this order right now?",
  soChatSuggest2: "When will it ship, and what has to land first?",
  soChatSuggest3: "Summarize everything for the weekly meeting.",
  soChatError: "Something went wrong. Try again.",
  soChatTooBig: "Attachments must total under 3.5 MB.",
  soChatThinking: "Thinking…",
  soChatYou: "You",
  soActionUndo: "Undo",
  soActionSend: "Send to Monday",
  soActionCancel: "Discard",
  soActionCorrection: "Correction recorded",
  soActionRetract: "Correction retracted",
  soActionNote: "Meeting note edited",
  soActionKeyPoints: "Key points updated",
  soActionMonday: "Monday draft",
  soStatusUndone: "Undone",
  soStatusSent: "Posted to Monday",
  soStatusCancelled: "Discarded",
  soStatusFailed: "Failed",
  soStatusPending: "Not posted until you send it",
...
const es: typeof en = {
  ...
  soChatShared: "Compartido con el equipo: todos ven esta conversación.",
  soChatPlaceholder: "Pregunta lo que quieras sobre esta orden, o dime qué corregir…",
  soChatSend: "Enviar",
  soChatClose: "Cerrar",
  soChatAttach: "Adjuntar imagen o PDF",
  soChatMic: "Dictar",
  soChatListening: "Escuchando… toca para parar",
  soChatEmpty:
    "Pregunta por el estado, fechas de llegada, cantidades, órdenes de compra o quién dijo qué. Dile una corrección y actualiza la tarjeta.",
  soChatSuggest1: "¿Qué está bloqueando esta orden ahora mismo?",
  soChatSuggest2: "¿Cuándo se envía y qué tiene que llegar antes?",
  soChatSuggest3: "Resume todo para la reunión semanal.",
  soChatError: "Algo salió mal. Inténtalo de nuevo.",
  soChatTooBig: "Los adjuntos deben sumar menos de 3,5 MB.",
  soChatThinking: "Pensando…",
  soChatYou: "Tú",
  soActionUndo: "Deshacer",
  soActionSend: "Enviar a Monday",
  soActionCancel: "Descartar",
  soActionCorrection: "Corrección registrada",
  soActionRetract: "Corrección retirada",
  soActionNote: "Nota de reunión editada",
  soActionKeyPoints: "Puntos clave actualizados",
  soActionMonday: "Borrador para Monday",
  soStatusUndone: "Deshecho",
  soStatusSent: "Publicado en Monday",
  soStatusCancelled: "Descartado",
  soStatusFailed: "Falló",
  soStatusPending: "No se publica hasta que lo envíes",
