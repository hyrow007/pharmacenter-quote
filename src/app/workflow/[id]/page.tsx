  ...
  return (
    <div className="app-shell">
      ...
      <main className="page">
        ...
        {/* Prominent "Back to workflows" pill — same look as the
            pill on /pricing for visual consistency. Sits above the
            eyebrow so it's the first thing the eye lands on. */}
        <a
          href="/workflows"
          style={{
            display: "inline-flex",
