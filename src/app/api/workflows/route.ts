...
export async function GET() {
  ...
  const { data, error } = await supabase
    .from("workflows")
    .select("id, quote_number, created_by_email, created_at, updated_at, state, status, sales_orders, description_override, monday_item_id, monday_item_url, monday_last_pushed_at")
